 ...
 <div className="container">
          ...
          <div className="flex text-center lg:text-left">
            ...
            <div className="w-full lg:w-1/3 px-4">
              ...
              <h5>
                <a href="tel:+13862439299">
                  <i className="fa fa-headset" aria-hidden="true"></i>
                  <span className='flex items-center gap-2'>  <LiaPhoneVolumeSolid  /> (386) 243-9299</span>
                </a>
              </h5>

              <h5 className='flex items-center gap-2  '>   <MdOutlineEmail className=" text-2xl text-[#0d419a] " /> sophia@healthymindcounselingcenter.com</h5>
              <h5 className='flex items-center gap-2  '>   <FaMapMarkerAlt className="text-2xl text-[#0d419a] " /> 395 Palm Coast Parkway SW</h5>
              <h5 className='flex items-center gap-2  ' >   <FaBuilding className="text-2xl text-[#0d419a] " /> Suite 4</h5>
              <h5 className='flex items-center gap-2  '><FaMapMarkerAlt className="text-2xl text-[#0d419a] " /> Palm Coast, FL 32137</h5>
